        ...
        <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="glass-card soft-shadow rounded-[1.75rem] p-8">
            <div className="space-y-5 text-base leading-7 text-zinc-600">
              <p>
                I'm Ondra Beránek, a developer focused on 
                web technologies, creative interfaces, and 
                software projects that make practical sense.
              </p>

              <p>
                My work usually connects frontend with backend logic, own
                tooling and experiments with technologies such as Next.js, React,
                TypeScript, Python or Three.js
              </p>

              <p>
                I enjoy creating projects that are technically interesting 
                and at the same time truly usable, whether it's developer 
